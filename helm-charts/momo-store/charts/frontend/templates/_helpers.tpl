...
helm.sh/chart: {{ include "momo-store.chart" . }}
...
*/}}
{{- define "momo-store.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "momo-store.fullname" .) .Values.serviceAccount.name }}
{{- else }}
